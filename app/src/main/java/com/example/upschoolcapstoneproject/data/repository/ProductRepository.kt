...
import com.example.upschoolcapstoneproject.data.mapper.mapProductEntityToProductUI
import com.example.upschoolcapstoneproject.data.mapper.mapProductToProductUI
import com.example.upschoolcapstoneproject.data.mapper.mapToProductEntity
import com.example.upschoolcapstoneproject.data.mapper.mapToProductUI
...
import com.example.upschoolcapstoneproject.data.source.local.ProductDao
import com.example.upschoolcapstoneproject.data.source.remote.ProductService
...
class ProductRepository(
    ...
    suspend fun addToCart(userId: String, productId: Int): Resource<AddToCartResponse> =
        withContext(Dispatchers.IO) {
            try {
    ...
    suspend fun deleteFromCart(userId: String, productId: Int): Resource<DeleteFromCartResponse> =
        withContext(Dispatchers.IO) {
            try {
                val response =
    ...
    suspend fun clearCart(userId: String): Resource<ClearCartResponse> =
        withContext(Dispatchers.IO) {
            try {
