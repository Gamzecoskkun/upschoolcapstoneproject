package com.example.upschoolcapstoneproject.data.mapper

import com.example.upschoolcapstoneproject.data.model.response.Product
import com.example.upschoolcapstoneproject.data.model.response.ProductEntity
